...
\begin {center}  
	\begin{tikzpicture}
    \node[state,initial where=left] (S0) {$S0$};
...
\begin{tikzpicture}
\node[state, initial] (q1) {$F1S0$};
\node[state, right of=q1] (q2) {$F1S1$};
\node[state, right of=q2] (q3) {$F1S2$};
\draw   
