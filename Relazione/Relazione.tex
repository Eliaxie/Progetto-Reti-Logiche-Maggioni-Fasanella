...
%FSM GENERALE:
	\begin{tikzpicture}
	[->,align=center,node distance=2cm, text width=10mm, ]
		\node[state] (F3S1) {$F3S1$};
		\node[state, above of = F3S1] (F3S0) {$F3S0$};
		\node[state, below of=F3S1] (F3S2) {$F3S2$};
		\node[state, below of=F3S2] (F3S3) {$F3S3$};
		\node[state, below of=F3S3] (F3S4) {$F3S4$};
		\node[state, below of=F3S4] (F3S5) {$F3S5$};
		\node[state, below of=F3S5] (F3S6) {$F3S6$};
		\node[state, below of=F3S6] (F3S7) {$F3S7$};
		\node[state, below of=F3S7] (F3S8) {$F3S8$};
	  \node[state, left of = F3S1, node distance=4cm] (F2S0) {$F2S0$};
		\node[state, below of=F2S0] (F2S1) {$F2S0$};
		\node[state, below of=F2S1] (F2S2) {$F2S1$};
		\node[state, below of=F2S2] (F2S3) {$F2S2$};
		\node[state, below of=F2S3] (F2S4) {$F2S3$};
		\node[state, below of=F2S4] (F2S5) {$F2S4$};
